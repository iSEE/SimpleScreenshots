...
initial[["RowDataPlot1"]] <- new("RowDataPlot", XAxis = "Row data", YAxis = "n_cells", XAxisRowData = "log10_total",
    ...
    ContourColor = "#0000FF", PointSize = 1, PointAlpha = 1,
    Downsample = FALSE, DownsampleResolution = 200, CustomLabels = FALSE,
    CustomLabelsText = "MIR1302-10", FontSize = 1, LegendPointSize = 1,
    LegendPosition = "Bottom", HoverInfo = TRUE, LabelCenters = FALSE,
    LabelCentersBy = "ENSEMBL_ID", LabelCentersColor = "#000000",
    VersionInfo = list(iSEE = structure(list(c(2L, 4L, 0L)), class = c("package_version",
...
initial[["ColumnDataTable1"]] <- new("ColumnDataTable", Selected = "Cell1", Search = "", SearchColumns = c("",
"", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "",
"", "", "", "", ""), HiddenColumns = character(0), VersionInfo = list(
    iSEE = structure(list(c(2L, 4L, 0L)), class = c("package_version",
...
initial[["SampleAssayPlot1"]] <- new("SampleAssayPlot", Assay = "logcounts", XAxis = "Sample name",
    XAxisRowData = "ENSEMBL_ID", XAxisSampleName = "Cell2", XAxisSampleSource = "---",
    XAxisSampleDynamicSource = FALSE, YAxisSampleName = "Cell1",
